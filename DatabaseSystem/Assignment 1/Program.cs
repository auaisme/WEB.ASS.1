    ...
    class InjectionClass {
        public static void Main() {
            ...
            while (true)
            {
                ...
                Console.Write("997: Show all cached Borrowers\n998: Show all cached Transactions\n999: Show all Data From DB\n");
                Console.Write(">> ");
                try
                {
                    ...
                    {
                        case 999:
                            library.displayAllFromDB();
                            break;
                        case 998:
                            library.printCachedTransactions();
                            break;
                        case 997:
                            library.printCachedBorrowers();
                            break;
                        case 1:
                            Console.Write("Title: ");
                            ...
                            library.addBook(new Book(library.getLatestBookID() + 1, isAvailable, title, author, genre));
                            break;
                        ...
                        case 4:
                            ...
                            library.registerBorrower(new Borrower(library.getLatestBorrowerID() + 1, name, email));
                            break;
                        ...
                        case 7:
                            ...
                            library.recordTransaction(new Transaction(library.getLatestTransactionID() + 1, id, id2, isBorrowed, DateTime.Now));
                            break;
